                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              //     // color: Get.isDarkMode? Colors.grey.withValues(alpha: 0.2): ColorResources.buttonBackgroundColorMap[advertisementController.advertisementDetailsModel?.advertisementData?.status],
                              //   ),
                              //   child: Center(
                              //     child: Text(
                              //       status!,
